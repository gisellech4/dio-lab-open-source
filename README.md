...
Repositório desenvolvido para fins didáticos, com a disponibilização de materiais de apoio para o lab. Alterado por Giselle. **Contribuindo em um Projeto Open Source no GitHub** da [Digital Innovation One](https://www.dio.me/).
...
5. Dentro da pasta [`community`](https://github.com/elidianaandrade/dio-lab-open-source/tree/main/community), crie um arquivo em Markdown (extensão `.md`) e nomeie com o mesmo nome do seu usuário no GitHub;
    ...
    > 1 - Para criar um arquivo via terminal utilize o  comando touch NOMEDAPASTA/SEUUSUARIO.md <br>
    > Exemplo: touch community/gisellech4.md <br>
    > Utiize o site readme.so para editar seu arquivo <br>
